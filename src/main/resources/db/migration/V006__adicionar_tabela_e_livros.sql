...
INSERT INTO `livros` (`titulo`, `autor`, `editora`, `cidade`,`ano`, `edicao`, `isbn`, `statusEmprestimo`) VALUES ('A Sutil Arte de Ligar o F*da-se', 'JMark Manson', 'Intrínseca', 'São Paulo', '2021', '2','8624365412345','disponível');
INSERT INTO `livros` (`titulo`, `autor`, `editora`, `cidade`,`ano`, `edicao`, `isbn`, `statusEmprestimo`) VALUES ('The Lord of the Rings Series', 'J. R. R. Tolkien', 'HarperCollins', 'São Paulo', '2019', '2','0024365429901','disponível');